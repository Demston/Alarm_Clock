...
# функции для сворачивания в трей и разворачивания
...
# Функция для ввода параметров будильника
def print_time():
...
# Функция для очистки параметров будильника
...
# Функция для обновления текущего времени в окне
def update_time():
